...
<div class="row">
	...
	<div class="col-lg-3" style="text-align: center;">
		<a href="gallary/show/{{$gallary->id}}">
			...
			<p style="color: red;"><span>Created at: </span>{{$gallary->created_at->diffforhumans()}}</p>
			<a href="/delete/{{$gallary->id}}" class="btn btn-warning">Delete Gallary</a>
		</div>
		@endforeach
	</div>
{{$gallaries->links()}}
